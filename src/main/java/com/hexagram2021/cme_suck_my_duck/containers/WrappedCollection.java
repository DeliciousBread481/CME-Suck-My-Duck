...
public class WrappedCollection<T> extends AbstractWrappedContainer<Collection<T>> implements Collection<T> {
	WrappedCollection(Collection<T> wrapped) {
		super(wrapped);
	}
	WrappedCollection(Collection<T> wrapped, String traceId) {
